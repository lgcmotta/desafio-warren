...
namespace DesafioWarren.UnitTests.Domain
{
    public class AccountBalanceTests
    {
        ...
        {
            var account1 = new Account("Foo", "foo@gmail.com", "+5551999999999", "123.456.789.10");
            
            var account2 = new Account("Bar", "bar@gmail.com", "+5551888888888", "098.765.432.10");

            Assert.Equal(0, account1.GetBalance());
            
            Assert.Equal(0, account2.GetBalance());

            account1.Deposit(100);

            account1.Transfer(account2, 50);

            Assert.Equal(50, account1.GetBalance());
            
            Assert.Equal(50, account2.GetBalance());
